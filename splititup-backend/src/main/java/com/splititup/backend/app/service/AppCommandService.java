package com.splititup.backend.app.service;

import com.splititup.backend.app.dto.*;
import com.splititup.backend.app.entity.*;
import com.splititup.backend.app.repository.ExpenseRepository;
import com.splititup.backend.app.repository.GroupMemberRepository;
import com.splititup.backend.app.repository.GroupRepository;
import com.splititup.backend.app.repository.SettlementRequestRepository;
...
public class AppCommandService {
    ...
    @Transactional(readOnly = true)
    public List<com.splititup.backend.user.dto.UserDirectoryItem> listGroupMembers(User currentUser, UUID groupId) {
        ...
        return groupMemberRepository.findByGroupId(groupId).stream()
                .map(gm -> new com.splititup.backend.user.dto.UserDirectoryItem(
                        gm.getUser().getId(),
                        gm.getUser().getName(),
                        gm.getUser().getEmail()
                ))
